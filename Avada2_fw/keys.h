...
const KeyData_t KeyData[] = {
        {GPIOA, 0, EVTMSK_NOTHING, EVTMSK_NOTHING,   EVTMSK_NOTHING, EVTMSK_NOTHING},
        {GPIOA, 1, EVTMSK_NOTHING, EVTMSK_NOTHING,   EVTMSK_NOTHING, EVTMSK_NOTHING},
        {GPIOA, 2, EVTMSK_NOTHING, EVTMSK_NOTHING,   EVTMSK_NOTHING, EVTMSK_NOTHING},
        {GPIOA, 3, EVTMSK_KEY_FIRE, EVTMSK_NOTHING,   EVTMSK_NOTHING, EVTMSK_NOTHING},
        {GPIOA, 4, EVTMSK_KEY_FIRE, EVTMSK_NOTHING,   EVTMSK_NOTHING, EVTMSK_NOTHING},
};
